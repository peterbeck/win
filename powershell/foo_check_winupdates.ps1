...
#
# CHANGELOG:
#     2014-03-08 - Updatetitel interessieren foo.li nicht... (Zeile 94/95)
...
#
# source: http://exchange.nagios.org/directory/Plugins/Operating-Systems/Windows-NRPE/Check-Windows-Updates-using-Powershell/details
#
##############################################################################
